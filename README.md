...
## Overview
SimpleCal is an event and calendar plugin for WordPress. It's probably pretty basic, unless I've made it awesome but forgotten to update the README. It uses custom post types and some metadata to store event details, and then it displays them as a widget or a shortcode.
