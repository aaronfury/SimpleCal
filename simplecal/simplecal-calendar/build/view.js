...
/* harmony import */ var react_date_object__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react-date-object */ "./node_modules/react-date-object/dist/index.module.js");



function AgendaItem(props) {
  var startDate = new react_date_object__WEBPACK_IMPORTED_MODULE_2__["default"](props.startDate * 1000);
  var endDate = new react_date_object__WEBPACK_IMPORTED_MODULE_2__["default"](props.endDate * 1000);
...
function SimpleCal({
  displayStyle,
  displayPastEvents,
  displayPastEventsDays,
  displayFutureEventsDays,
  agendaShowMonthYearHeaders,
  agendaPostsPerPage,
  agendaShowThumbnail,
  agendaShowExcerpt
}) {
  let currentDate = new Date();
  const [calItems, setCalItems] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
  const [agendaPage, setAgendaPage] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(1);
  const [calendarMonth, setCalendarMonth] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(currentDate.getMonth());
  var queryParams = {
  ...
  const fetchCalItems = async () => {
    await _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_2___default()({
      path: (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_3__.addQueryArgs)('simplecal/v1/events', queryParams)
    }).then(response => {
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.ButtonGroup, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.Button, {
    variant: "primary",
    onClick: () => setAgendaPage(agendaPage - 1)
  }, "Previous Page"), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.Button, {
    onClick: () => setAgendaPage(agendaPage + 1)
  }, "Next Page")), calItems.map(item => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_Components_AgendaItem__WEBPACK_IMPORTED_MODULE_6__["default"], {
    title: item.title,
    startDate: item.startDate,
