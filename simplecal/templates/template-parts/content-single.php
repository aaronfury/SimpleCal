<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry_header alignwide">	
		...
		<div class="simplecal_event_meta">
			...
			<?php
				if (SimpleCal\Helper::event_has_valid_end_timestamp()) {
			?>
			<div class="simplecal_event_meta_row">
			...
			<?php
				...
				if (SimpleCal\Helper::event_get_the_location(check_only:true) && (!$post->simplecal_event_private_location || (($post->simplecal_event_private_location) && is_user_logged_in()))) {
			?>
			<div class="simplecal_event_meta_row">
